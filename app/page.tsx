    ...
    <div className="min-h-screen w-full relative bg-black">
      ...
      <header
        className={`sticky top-4 z-[9999] mx-auto hidden w-full flex-row items-center justify-between self-start rounded-full bg-background/80 md:flex backdrop-blur-sm border border-border/50 shadow-lg transition-all duration-300 ${
          isScrolled ? "max-w-5xl px-3" : "max-w-6xl px-6"
        } py-2`}
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-4 text-sm font-medium text-muted-foreground transition duration-200 hover:text-foreground md:flex md:space-x-6">
          <a
          ...
          >
            <span className="relative z-20">Equipo</span>
          </a>
          <a
            className="relative px-3 py-2 text-muted-foreground hover:text-foreground transition-colors cursor-pointer whitespace-nowrap"
            onClick={(e) => {
