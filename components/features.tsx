  ...
  return (
    <section id="features" className="text-foreground relative overflow-hidden py-12 sm:py-24 md:py-32">
      ...
      <motion.div
        ...
        className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-6 sm:gap-12"
      >
        <h2
          className={cn(
        ...
        >
          Construyendo el futuro a tu medida
        </h2>
        <FollowerPointerCard
          title={
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
              ...
              >
                ...
                <div className="pointer-events-none flex grow items-center justify-center select-none relative">
                  <div
                    className="relative w-full h-[250px] sm:h-[350px] rounded-xl overflow-hidden"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        {/* Center Logo */}
                        <motion.div
                          className="w-16 h-16 border border-gray-300 rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-[#e78a53] to-[#e78a53]/80 flex items-center justify-center"
              ...
              >
                ...
                <div className="flex min-h-[200px] sm:min-h-[250px] grow items-start justify-center select-none">
              ...
              >
                ...
                <div className="flex grow items-center justify-center select-none relative min-h-[280px] sm:min-h-[320px] p-2 sm:p-4">
